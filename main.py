...
def main_run(numEpochs, lr, stepSize, decayRate, trainBatchSize, seqLen, memSize,
    ...
    vidSeqTrain = VideoDataset(trainDataset, trainLabels, trainNumFrames, spatial_transform=spatial_transform,
                                seqLen=seqLen)
    ...
    vidSeqTest = VideoDataset(testDataset, testLabels, testNumFrames, seqLen=seqLen,
